// src/components/dashboard/KpiTiles/SalesBar/SalesBar.tsx
// SalesBar with pastel traffic-light background (red→amber→green) based on score/targets.
...
// compute score using optional green/red targets (higher is better for Sales)
function computeScore({
  ...
  if (G != null && R != null && G !== R) {
    // higher is better for Sales
    const t = (value - R) / (G - R);
    return clamp(Math.round(t * 100));
  }
  // fallback: any positive sales is “good-ish”
